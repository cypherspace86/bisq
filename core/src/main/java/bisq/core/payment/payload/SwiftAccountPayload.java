...
@Getter
@Slf4j
public final class SwiftAccountPayload extends CountryBasedPaymentAccountPayload {
    @Setter
    ...
    public SwiftAccountPayload(String paymentMethod, String id, List<Country> acceptedCountries) {
    ...
    private SwiftAccountPayload(String paymentMethodName,
                                String id,
                                String countryCode,
                                String holderName,
                                String iban,
    ...
    public Message toProtoMessage() {
        PB.SwiftAccountPayload.Builder builder =
                PB.SwiftAccountPayload.newBuilder()
        ...
        final PB.CountryBasedPaymentAccountPayload.Builder countryBasedPaymentAccountPayload = getPaymentAccountPayloadBuilder()
                ...
                .setSwiftAccountPayload(builder);
    ...
    public static PaymentAccountPayload fromProto(PB.PaymentAccountPayload proto) {
        ...
        PB.SwiftAccountPayload swiftAccountPayloadPB = countryBasedPaymentAccountPayload.getSwiftAccountPayload();
        return new SwiftAccountPayload(proto.getPaymentMethodId(),
                proto.getId(),
                countryBasedPaymentAccountPayload.getCountryCode(),
                swiftAccountPayloadPB.getHolderName(),
                swiftAccountPayloadPB.getIban(),
                swiftAccountPayloadPB.getBic(),
                swiftAccountPayloadPB.getEmail(),
                new ArrayList<>(swiftAccountPayloadPB.getAcceptedCountryCodesList()),
    ...
    public String getPaymentDetails() {
        return "SWIFT - Holder name: " + holderName + ", IBAN: " + iban + ", BIC/SWIFT: " + bic + ", Country code: " + getCountryCode();
    }
